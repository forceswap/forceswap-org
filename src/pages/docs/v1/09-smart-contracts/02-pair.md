...
This documentation covers forceswap-specific functionality. For ERC-20 functionality, see <Link to='/docs/v1/smart-contracts/pair-erc-20'>Pair (ERC-20)</Link>.

# Code

[`forceswapV1Pair.sol`](https://github.com/forceswap/forceswap-v1-core/blob/master/contracts/forceswapV1Pair.sol)
