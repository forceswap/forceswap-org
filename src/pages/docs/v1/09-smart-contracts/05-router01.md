...
<Info>
forceswapV1Router01 should not be used any longer, because of the discovery of a <Link to='/docs/v1/smart-contracts/router01#getamountin'>low severity bug</Link> and the fact that some methods do not work with tokens that take fees on transfer. The current recommendation is to use <Link to='/docs/v1/smart-contracts/router02'>forceswapV1Router02</Link>.
</Info>

# Code

[`forceswapV1Router01.sol`](https://github.com/forceswap/forceswap-V1-Periphery/blob/master/contracts/forceswapV1Router01.sol)

# Address

`forceswapV1Router01` is deployed at `0x404A895237C97B75d4Cf96C8Ad9760687692613A` on the Ethereum [mainnet](https://etherscan.io/address/0x404A895237C97B75d4Cf96C8Ad9760687692613A), and the [Ropsten](https://ropsten.etherscan.io/address/0x404A895237C97B75d4Cf96C8Ad9760687692613A), [Rinkeby](https://rinkeby.etherscan.io/address/0x404A895237C97B75d4Cf96C8Ad9760687692613A), [Görli](https://goerli.etherscan.io/address/0x404A895237C97B75d4Cf96C8Ad9760687692613A), and [Kovan](https://kovan.etherscan.io/address/0x404A895237C97B75d4Cf96C8Ad9760687692613A) testnets. It was built from commit [2ad7da2](https://github.com/forceswap/forceswap-V1-Periphery/tree/2ad7da28a6f70ec4299364bc1608af8f30e7646b).
...
Removes liquidity from an ERC-20⇄ERC-20 pool without pre-approval, thanks to <Link to='/docs/v1/smart-contracts/pair-erc-20/#permit'>permit</Link>.
...
Removes liquidity from an ERC-20⇄WETTH pool and receive ETH without pre-approval, thanks to <Link to='/docs/v1/smart-contracts/pair-erc-20/#permit'>permit</Link>.
...
```solidity
import '@forceswap/v1-periphery/contracts/interfaces/IforceswapV1Router01.sol';
```

```solidity
pragma solidity >=0.6.2;

interface IforceswapV1Router01 {
  function factory() external pure returns (address);
  function WETH() external pure returns (address);
...
```typescript
import IforceswapV1Router01 from '@forceswap/v1-periphery/build/IforceswapV1Router01.json'
```
