...
This example makes use of the <Link to='/docs/v1/SDK/getting-started/'>forceswap SDK</Link>. In reality, the SDK computes pair addresses behind the scenes, obviating the need to compute them manually like this.

```typescript
import { FACTORY_ADDRESS, INIT_CODE_HASH } from '@forceswap/sdk'
