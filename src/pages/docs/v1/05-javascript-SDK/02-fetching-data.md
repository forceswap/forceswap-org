...
```typescript
import { ChainId, Token } from '@forceswap/sdk'
...
```typescript
import { ChainId, Token, Fetcher } from '@forceswap/sdk'
...
Now that we've explored how to define a token, let's talk about pairs. To read more about what forceswap pairs are, see <Link to='/docs/v1/smart-contracts/pair'>Pair</Link>.
...
```typescript
import { ChainId, Token, WETH, Pair, TokenAmount } from '@forceswap/sdk'
...
```typescript
import { ChainId, Token, WETH, Fetcher } from '@forceswap/sdk'
