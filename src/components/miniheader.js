...
import force from '../images/force_inline.png'
...
const Header = props => {
  ...
  const v2Toggle = props.path.slice(0, 8) === '/docs/v1'
    ...
    <StyledHeader open={isMenuOpen}>
      <Row>
          ...
          {props.path && props.path !== '/' && props.path !== '' && (
            <>
              <StyledNavTitle to={'/' + props.path.split('/')[1]}>
                {props.path.length > 20 ? 'Docs /' : 'forceswap Docs /'}
              </StyledNavTitle>
        ...
        <StyledNav ref={node} open={isMenuOpen}>
          ...
          {isMobile &&
            (v2Toggle ? <SidebarV2 parent={'/docs/'} {...props} /> : <SidebarV2 parent={'/docs/'} {...props} />)}
          <StyledButton type="button" onClick={toggleDarkMode}>
            {darkMode ? <Sun size={20} /> : <Moon size={20} />}
          </StyledButton>
          <StyledButton fill>
            <a href="https://github.com/forceswap">
              <Github width={20} />
            </a>
          </StyledButton>
