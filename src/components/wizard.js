...
const links = [
    ...
    sublinks: [
      {
        ...
        description: 'Simplify the process of integrating forceswap into your project.',
        tag: 'reference',
        icon: '🖥️'
      },
      {
        title: 'Introduction to Oracles',
        link: '/docs/v1/core-concepts/oracles/',
  ...
  },
  {
    ...
    sublinks: [
      {
        title: 'Anatomy of a forceswap Pool',
        link: '/docs/v1/pools',
        description: 'An overview of what a forceswap liquidity pool.'
      },
      {
        title: 'Understanding Liquidity Returns',
        link: '/docs/v1/pools/understanding-returns',
    ...
    sublinks: [
      {
        ...
        description: 'A high level technical overview of the forceswap protocol.'
      }
    ]
  }
]
